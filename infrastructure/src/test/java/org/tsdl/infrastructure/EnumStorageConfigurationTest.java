...
class EnumStorageConfigurationTest {
  ...
  void simpleConfiguration_getProperty_validTargetType_works() {
    ...
    var prop = (Object) config.getProperty(TestStorageConfigurationProperty1.PROP1, char[].class);
  ...
  static class SimpleStorageConfiguration extends EnumStorageConfiguration {
  ...
  static class CombinedStorageConfiguration extends EnumStorageConfiguration {
